...
Outside work, I am a husband, a father, and still curious about what technology can mean in real life.
...
Designing AI-assisted visualization systems that turn market signals, documents, and structured data into clear visual outputs for end users.

### Agent workflows for research and decision support

Building retrieval and orchestration pipelines that connect knowledge, reasoning, and interface layers in practical fintech products.

### Visualization infrastructure

Leading reusable foundations for charts, interaction patterns, and rendering workflows that support multiple products and teams.

## Core Stack

TypeScript, JavaScript, Python, SQL, WebGL/Three.js, data visualization, RAG systems, AI agents, Linux

## Writing & Contact

- Website: [zhouchangju.com](https://zhouchangju.com/)
- GitHub: [@zhouchangju](https://github.com/zhouchangju)
- Open to conversations about AI applications, visual systems, and fintech product engineering.
